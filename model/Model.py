...
from model.transformer.Transformers import Encoder_video_cms
from model.Decoder import Decoder
from model.Decoder import Decodercms
...
class HybirdNet(nn.Module):
    ...
    def __init__(
            ...
            n_layers=6, rnn_layers=1, n_head=8, d_k=64, d_v=64, dropout=0.1, d_cms=768,
    ...
    def forward(self, vis_feat, i3d, aud, tgt_seq, tgt_pos,
                cms_seq_int, cms_pos_int, cms_seq_eff, cms_pos_eff, cms_seq_att, cms_pos_att, bert_cls):
