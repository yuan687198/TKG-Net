...
def parse_opt():
    ...
    parser.add_argument(
        ...
        nargs='*',
        type=str,
        default=['data/audio_features'],
        # default=['C:/audio_features'],
        help='path to the directory containing the preprocessed fc feats')
    ...
    parser.add_argument('--model_name', default='/data/yuanmq/hybridnet/0.2all_lr3e-4.pt', type=str, action='store',
