...
def load_models():
	...
	tokenizer = GPT2Tokenizer.from_pretrained('/data/yuanmq/GPT2/gpt/gptmedium')
	model = GPT2LMHeadModel.from_pretrained('/data/yuanmq/GPT2/gpt/gptmedium')
...
if __name__ == '__main__':
	...
	parser.add_argument('--epoch', default= 30,type=int, action='store', help='Number of epochs to run')
	parser.add_argument('--warmup', default=300, type=int, action='store', help='Number of warmup steps to run')
	parser.add_argument('--model_name', default='mymodel_att1.pt', type=str, action='store', help='Name of the model file')
	parser.add_argument('--data_file', default='data/gpt_attribute.txt', type=str, action='store', help='Name of the data file')
